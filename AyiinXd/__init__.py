...
CHANNEL = os.environ.get("CHANNEL", "night_userbot")
...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "ʜᴇʏ, ꜱᴀʏᴀ ᴘᴇɴɢɢᴜɴᴀ ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ")
...
ALIVE_LOGO = (os.environ.get("ALIVE_LOGO")
              or "https://files.catbox.moe/qra7pc.jpg")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
...
with bot:
    try:
        ...
        logoyins = random.choice(
            [
                "https://files.catbox.moe/qra7pc.jpg",
            ]
        )
        cmd = CMD_HANDLER
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS or event.query.user_id in VVIP:
                try:
                    ...
                    text = f"**📍 Night-Userbot Inline Menu 📍**\n\n㊪ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n㊪ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n㊪ **ᴏᴡɴᴇʀ** {user.first_name}\n㊪ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid or event.query.user_id in VVIP and query.startswith(
                ...
                result = builder.article(
                    title="Repository",
                    description="Repository ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/night_userbot",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text="**ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ**\n➖➖➖➖➖➖➖➖➖➖\n㊪  **ʀᴇᴘᴏ :** [ᴏᴡɴᴇʀ』](https://t.me/minbey)\n㊪ **sᴜᴘᴘᴏʀᴛ :** @night_userbot\n㊪ **ʀᴇᴘᴏsɪᴛᴏʀʏ :** [ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ](https://github.com/hana624/Night-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "sᴜᴘᴘᴏʀᴛ",
                                "https://t.me/night_userbot"),
                            custom.Button.url(
                                "ʀᴇᴘᴏ",
                                "https://github.com/hana624/Night-Userbot"),
                        ],
                    ],
                    link_preview=False,
                )
                ...
                result = builder.article(
                    title="String",
                    description="String ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ",
                ...
                result = builder.article(
                    title="Lang",
                    description="Lang ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ",
                    url="https://t.me/night_userbot",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
                ...
                result = builder.article(
                    title="ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ",
                    description="ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ | Telethon",
                    url="https://t.me/night_userbot",
                    thumb=InputWebDocument(
                        INLINE_PIC,
                        0,
                        "image/jpeg",
                        []),
                    text=f"**ɴɪɢʜᴛ-ᴜꜱᴇʀʙᴏᴛ**\n➖➖➖➖➖➖➖➖➖➖\n㊪ **ᴏᴡɴᴇʀ :** [{user.first_name}](tg://user?id={user.id})\n㊪ **ᴀssɪsᴛᴀɴᴛ:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**ᴜᴘᴅᴀᴛᴇs :** @night_userbot\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url(
                                "ɢʀᴏᴜᴘ",
...
""")
        ...
        LOGS.info(
            f"KALO BOT LU NGECRASH, KLIK SAVE YANG DI POJOK KANAN BAWAH DAN KIRIM KE @night_userbot » TAG @minbey ATAU ADMIN LAINNYA » Info By: Night-Userbot {BOT_VER}")
