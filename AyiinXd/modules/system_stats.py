...
async def amireallyalive(alive):
    ...
    buttons = [
        [Button.url("Support", "https://t.me/mt_force"), Button.url("Channel", "https://t.me/ruangprojects")]
    ]
    ...
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
            await alive.delete()
            msg = await alive.client.send_file(alive.chat_id, logo, caption=output, buttons=buttons)
        ...
        await edit_or_reply(alive, output, buttons=buttons)
