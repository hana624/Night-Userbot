...
async def fuck():
    try:
        await bot(Get("night_userbot"))
        await bot(Get("ruangprojects"))
    except rpcerrorlist.ChannelPrivateError:
        print("Anda Diban Dari Group Support !!! Coba Tanyakan Ke @minbey agar Di Unban.")
        sys.exit(1)


async def checking(client):
    checkxd = str("@ruangprojects")
    checkmd = str("@night_userbot")
    if client:
        try:
            ...
            print(
                "Anda Diban Dari Group Support !!! Coba Tanyakan Ke  @minbey agar Di Unban.")
            sys.exit(1)
